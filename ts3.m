clc;
clearvars -except X1 Y1x Y1y X2 Y2x Y2y;
%%%
coord = readmatrix("gait_data_3.xlsx");
time = coord(:,1);
tfit = time;
tt = time;
%%%
...
%%% GRFs
f = readmatrix("grf_data_3.xlsx");
tf = f(:,1);
gt = 1:15:2521;
GRFx = f(gt,2);
GRFy = f(gt,3);
mark = 6:110; % full gait cycle
%mark = 6:72; % non zero GRF
%mark = 6:20; % first DS
%mark = 57:72; % second DS
%%%
