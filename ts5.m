clc;
clearvars -except X1 Y1x Y1y X2 Y2x Y2y X3 Y3x Y3y X4 Y4x Y4y;
%%%
coord = readmatrix("gait_data_5.xlsx");
time = coord(:,1);
tfit = time;
tt = time;
%%%
...
%%% GRFs
f = readmatrix("grf_data_5.xlsx");
tf = f(:,1);
gt = 1:15:2701;
GRFx = f(gt,2);
GRFy = f(gt,3);
mark = 18:133; % full gait cycle
%mark = 62:133; % non zero GRF
%mark = 62:76; % first DS
%mark = 118:133; % second DS
%%%
